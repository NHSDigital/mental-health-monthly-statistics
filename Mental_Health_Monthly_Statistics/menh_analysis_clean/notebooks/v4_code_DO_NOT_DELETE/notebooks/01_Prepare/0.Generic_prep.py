...
# DBTITLE 1,MHS101Referral_open_end_rp - Referral table, latest month and open end RP
 ...
 -- GBT replacing ref.* here with a list of all columns to allow the _v sourced menhprimary_refresh and menh_point_in_time tables to be used as source data too.
