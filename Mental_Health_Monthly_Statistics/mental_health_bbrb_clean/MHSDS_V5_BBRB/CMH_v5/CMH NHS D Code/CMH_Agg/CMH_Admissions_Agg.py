...
# DBTITLE 1,MHS107a - England - Rates of admission with contact
 ...
 '' AS MEASURE_NAME,
 --ROUND((SUM(Contact)/SUM(Admissions))*100, 1) AS MEASURE_VALUE
...
# DBTITLE 1,MHS106a - SubICB - Admissions with contact
 ...
 '$rp_enddate' AS REPORTING_PERIOD_END_DATE,
 '$status' AS STATUS,
 'Sub ICB of Residence' AS BREAKDOWN, -- aded extra space 4/10/22
 h.CCG21CDH AS PRIMARY_LEVEL,
 h.CCG21NM AS PRIMARY_LEVEL_DESCRIPTION,
 'NONE' AS SECONDARY_LEVEL,
 'NONE' AS SECONDARY_LEVEL_DESCRIPTION,
...
# DBTITLE 1,MHS106 - Ethnicity - Admissions
 ...
 '$rp_enddate' AS REPORTING_PERIOD_END_DATE,
 '$status' AS STATUS,
 'England; Ethnicity (White British/Non-White British)' AS BREAKDOWN,
...
# DBTITLE 1,MHS106 - ICB; Ethnicity - Admissions
 ...
 '$rp_enddate' AS REPORTING_PERIOD_END_DATE,
 '$status' AS STATUS,
 'ICB of Residence; Ethnicity (White British/Non-White British)' AS BREAKDOWN,
