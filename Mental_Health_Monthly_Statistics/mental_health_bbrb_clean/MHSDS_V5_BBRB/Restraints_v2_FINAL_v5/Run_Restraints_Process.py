...
dbutils.widgets.text("month_id", "1461")
...
#when checking against $db_source data using $db_source, Submission Picker Cell needs editing in the below notebook - details in that cell
...
# DBTITLE 1,Main Dashboard CSV - Suppressed
 %sql
 select * from global_temp.final_supp_table2 order by ReportingPeriodStartDate
...
dbutils.notebook.exit(json.dumps({
  "status": "OK",
  "unsuppressed_table": "restraints_final_output1",
