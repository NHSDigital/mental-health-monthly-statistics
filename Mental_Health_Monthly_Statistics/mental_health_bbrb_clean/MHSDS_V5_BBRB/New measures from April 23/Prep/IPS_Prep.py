...
# DBTITLE 1,Get MPI Table for Rolling 12 month period
 ...
 LEFT JOIN $ref_database.ENGLISH_INDICES_OF_DEP_V02 IMD 
                     on MPI.LSOA2011 = IMD.LSOA_CODE_2011 
                     and IMD.imd_year = '2019'
 LEFT JOIN $db_output.mhsds_org_daily OD on MPI.OrgIDProv = OD.ORG_CODE
...
# DBTITLE 1,Get SNOMED Interventions for IPS (All Providers)
 ...
 AND (a.Der_SNoMEDProcQual != 443390004 OR a.Der_SNoMEDProcQual IS NULL)--to make sure 443390004 is filtered out and not removing nulls
...
# DBTITLE 1,Insert IPS Care Contacts Referral Records for IPS SNOMED activity (instead of ServTeamTypeRefToMH) into ips_activity
 ...
 AND (i.Der_SNoMEDProcQual != 443390004 OR i.Der_SNoMEDProcQual IS NULL) --to make sure 443390004 is filtered out
...
# DBTITLE 1,Final Prep Table for Counts
 ...
 LEFT JOIN $db_output.mhsds_stp_mapping i ON r.OrgIDCCGRes = i.ccg_code  
