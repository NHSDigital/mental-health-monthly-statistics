...
# DBTITLE 1,CODE 27 - Inappropriate OAPS Bed Days in Period
# Prep tables build
...
# DBTITLE 1,Remove Code 27 results from output
 %sql
...
# DBTITLE 1,England Month
 ...
 FROM (    SELECT
             ...
             SUM(CASE WHEN ReasonOAT = 10 THEN BedDaysWSEndRP ELSE 0 END) metric_value
