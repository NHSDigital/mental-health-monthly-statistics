...
# DBTITLE 1,CODE 10 - OAPS Started in Period
# Prep tables build
...
# COMMAND ----------
 ...
 SELECT  'OAPS01' AS metric,
         'Number of OAPs placements (not bed-nights) started in the period' AS metric_description

# COMMAND ----------

# DBTITLE 1,Remove Code 10 results from output
# %sql
...
# DBTITLE 1,England Month
 ...
 FROM (    SELECT
           ...
           WHERE uniqmonthid = $end_month_id) AS a
...
# DBTITLE 1,England Rolling 3 month
 ...
 FROM (    SELECT
           ...
           FROM $db_output.OAPs AS a
           WHERE uniqmonthid between $end_month_id-2 and $end_month_id) AS a
 CROSS JOIN $db_output.metric_info AS b
