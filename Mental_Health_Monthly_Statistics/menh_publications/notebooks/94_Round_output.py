...
# DBTITLE 1,1-5. Round and format most products (for Sub-England figures)
 ...
 SELECT DISTINCT
     ...
     a.STATUS, 
       ...
       WHEN a.REPORTING_PERIOD_END > '2022-07-01' AND a.BREAKDOWN = 'CCG - GP Practice or Residence; Age'  THEN 'Sub ICB - GP Practice or Residence; Age'
       WHEN a.REPORTING_PERIOD_END > '2022-07-01' AND a.BREAKDOWN = 'CCG - GP Practice or Residence; Gender'  THEN 'Sub ICB - GP Practice or Residence; Gender'
       WHEN a.REPORTING_PERIOD_END > '2022-07-01' AND a.BREAKDOWN = 'CCG - GP Practice or Residence; IMD Decile'  THEN 'Sub ICB - GP Practice or Residence; IMD Decile'
