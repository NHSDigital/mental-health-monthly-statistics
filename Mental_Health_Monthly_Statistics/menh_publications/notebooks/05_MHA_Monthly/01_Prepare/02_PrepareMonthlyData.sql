...
('England','England','England','NONE','NONE','MHS81a','Detentions in RP per 100,000 population'),
('England','England','England','NONE','NONE','MHS84a','CTOs in RP per 100,000 population'),
('England','England','England','NONE','NONE','MHS143','Uses of Section 2 in RP'),
('England','England','England','NONE','NONE','MHS144','Uses of Section 3 in RP'),
('England','England','England','NONE','NONE','MHS145','Uses of Part 3 of the Act in RP')
...
CROSS JOIN (SELECT DISTINCT A.ORG_CODE, A.NAME
    ...
    ON A.MEASURE_ID IN ('MHS81','MHS82','MHS83','MHS84','MHS143','MHS144') and a.Breakdown = 'England'

WHERE A.MEASURE_ID IN ('MHS81','MHS82','MHS83','MHS84','MHS143','MHS144') and a.Breakdown = 'England'
UNION
SELECT 
...
FROM $db_output.MHA_Monthly_CSV A
  CROSS JOIN (SELECT DISTINCT IC_REC_CCG, NAME FROM $db_output.CCG ) AS y
      ON A.MEASURE_ID IN ('MHS81','MHS82','MHS83','MHS84','MHS81a','MHS84a','MHS143','MHS144') and a.Breakdown = 'England'

WHERE A.MEASURE_ID IN ('MHS81','MHS82','MHS83','MHS84','MHS81a','MHS84a','MHS143','MHS144') and a.Breakdown = 'England'
