...
measure_metadata = {
  "ALL": {**los_measure_ids, **cmh_measure_ids, **cyp_peri_measure_ids, **cyp_out_measure_ids, **uec_measure_ids, **ips_measure_ids, **oaps_measure_ids},
  "01_LOS": los_measure_ids,
  "02_AUTISM": aut_measure_ids,
