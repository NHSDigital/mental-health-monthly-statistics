...
# DBTITLE 1,MHS96 - England; Restrictive Intervention Type
 ...
 'MHSXX' as metric,
 (select sum(der_bed_days) from $db_output.RI_FINAL b)  as metric_value                                    -------AM: Updated this to be in line with how MHS96 is calculated
...
# DBTITLE 1,MHSXXa - Specialised Commissioning Service; Restrictive Intervention Type
 %sql
 insert into $db_output.restraints_final_output
 select
 '$rp_startdate' as ReportingPeriodStartDate,
...
# DBTITLE 1,MHSXXa - Region; Specialised Commissioning Service; Restrictive Intervention Type
 %sql
 insert into $db_output.restraints_final_output
 select
 '$rp_startdate' as ReportingPeriodStartDate,
...
# DBTITLE 1,MHSXXa - Region; Provider; Specialised Commissioning Service; Restrictive Intervention Type
 %sql
 insert into $db_output.restraints_final_output
 select
 '$rp_startdate' as ReportingPeriodStartDate,
...
# DBTITLE 1,MHSXXa - Provider; Specialised Commissioning Service; Restrictive Intervention Type
 %sql
 insert into $db_output.restraints_final_output
 select
 '$rp_startdate' as ReportingPeriodStartDate,
