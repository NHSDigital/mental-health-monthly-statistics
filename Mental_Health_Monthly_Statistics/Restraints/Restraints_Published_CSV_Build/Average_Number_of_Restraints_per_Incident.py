...
# DBTITLE 1,MHS137 - England
 ...
 'MHS137' as metric,
 count(distinct UniqRestrictiveIntIncID, UniqRestrictiveIntTypeID) / count(distinct UniqRestrictiveIntIncID) as metric_value
 from $db_output.RI_FINAL
 where person_id is not null

# COMMAND ----------

# DBTITLE 1,MHS137 - Region
 %sql
 insert into $db_output.restraints_final_output
 select
 '$rp_startdate' as ReportingPeriodStartDate,
