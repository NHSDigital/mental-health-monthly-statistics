...
# schedule updated to run DAILY at 20:20 (advice is not to schedule jobs to start on the hour or half hour to reduce risk of resource contention)
run_notebooks = {
  "concurrency": 1,
  "extra_parameters": {},
  "schedule": "0 20 20 1/1 * ? *"
}
