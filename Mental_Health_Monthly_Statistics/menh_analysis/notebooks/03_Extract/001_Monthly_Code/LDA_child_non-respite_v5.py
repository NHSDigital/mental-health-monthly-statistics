...
# COMMAND ----------
 ...
 FROM    $db_source.MHS001MPI M 
         ...
         LEFT JOIN (
           select UniqMonthID, UniqHospProvSpellID, StartDateDelayDisch, EndDateDelayDisch, DelayDischReason from $db_source.MHS504DelayedDischarge 
           union all 
         ...
         ) as DD ON H.UniqHospProvSpellID = DD.UniqHospProvSpellID AND DD.UniqMonthID = '$month_id' AND DD.EndDateDelayDisch IS NULL-- and DD.ic_use_submission_flag = 'y' -- needed for testing in hue
         LEFT JOIN 
