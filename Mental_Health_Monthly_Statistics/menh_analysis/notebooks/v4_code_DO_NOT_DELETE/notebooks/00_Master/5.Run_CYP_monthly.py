...
dbutils.notebook.run("../02_Aggregate/5.CYP_monthly_agg/1.National/Outpatient Other", 0, params)

# 2.CCG
dbutils.notebook.run("../02_Aggregate/5.CYP_monthly_agg/2.CCG/Inpatient measures", 0, params)
dbutils.notebook.run("../02_Aggregate/5.CYP_monthly_agg/2.CCG/Outpatient Other", 0, params)

# 3.Provider
dbutils.notebook.run("../02_Aggregate/5.CYP_monthly_agg/3.Provider/Inpatient measures", 0, params)
dbutils.notebook.run("../02_Aggregate/5.CYP_monthly_agg/3.Provider/Outpatient Other", 0, params)
