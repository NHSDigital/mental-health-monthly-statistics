...
# Debugging
params = {'current_env': 'ref', 'month_id': '1418', 'db': 'temp_menh_analysis1', 'dbm': 'mh_cur_clear', 'status': 'Provisional', 'rp_enddate': '2018-05-31', 'rp_startdate': '2018-05-01'}
...
# this won't work under the current set up - extracts have to be done by a person into an S3 bucket...

# dbutils.notebook.run("../03_Extract/6.LDA", 0, params)