...
# DBTITLE 1,MH01a Provider - commented out
 ...
 -- 			,'MH01a' AS METRIC
 -- 			,CAST (IFNULL( cast(COUNT (DISTINCT Person_ID) as INT), 0) AS STRING) AS METRIC_VALUE
...
# DBTITLE 1,MHS21a
 ...
 INSERT INTO $db_output.CYP_monthly_unformatted
     SELECT '$rp_startdate' AS REPORTING_PERIOD_START
 		    ...
 		    ,'NONE' AS SECONDARY_LEVEL_DESCRIPTION
             ,'MHS21a' AS METRIC
             ,COUNT (DISTINCT WRD.UniqWardStayID) AS METRIC_VALUE
             ,'$db_source' AS SOURCE_DB
  ...
  INNER JOIN $db_output.MHS001MPI_latest_month_data AS MPI
       ...
       WHERE WRD.UniqMonthID = '$month_id' 
 	        ...
 	        AND MPI.AgeRepPeriodEnd between 0 and 18
