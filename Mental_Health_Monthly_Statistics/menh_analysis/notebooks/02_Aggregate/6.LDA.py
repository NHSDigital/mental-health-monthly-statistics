...
# 'TCP Region' as Geography
# FROM reference_data.ORG_RELATIONSHIP_DAILY o1 
# LEFT JOIN reference_data.ORG_RELATIONSHIP_DAILY o2 on o2.REL_FROM_ORG_CODE = o1.REL_TO_ORG_CODE and o2.REL_TYPE_CODE = 'CFCE' and o2.REL_IS_CURRENT = 1
# LEFT JOIN reference_data.ORG_DAILY o3 on o3.ORG_CODE = o2.REL_TO_ORG_CODE and o3.ORG_IS_CURRENT = 1;

# CREATE OR REPLACE TEMP VIEW TCPList AS
# SELECT DISTINCT NHS_ENGLAND_TCP_CODE,
#                 TCP_NAME,
#                 'TCP' as Geography
# FROM reference_data.nhse_ccg_tcp_v01
