...
SELECT DISTINCT
  ...
  FROM global_temp.providers_between_rp_start_end_dates -- WARNING: The data in this view differs depending on the month_id
UNION ALL
SELECT 
  'England' as Level, 
...
UNION ALL  
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'White' as secondary_level, 'White' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Mixed' as secondary_level, 'Mixed' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Asian or Asian British' as secondary_level, 'Asian or Asian British' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Black or Black British' as secondary_level, 'Black or Black British' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Other Ethnic Groups' as secondary_level, 'Other Ethnic Groups' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Not Stated' as secondary_level, 'Not Stated' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates
UNION ALL
SELECT DISTINCT ORG_CODE as level, NAME as level_desc, 'Unknown' as secondary_level, 'Unknown' as secondary_level_desc, 'Provider; Ethnicity' as breakdown FROM global_temp.providers_between_rp_start_end_dates;
...
SELECT *
FROM $database.snomed_sct2_concept_full
...
SELECT *
FROM $database.snomed_sct2_description_full
...
SELECT db1_KEY,ID, EFFECTIVETIME ,ACTIVE ,MODULEID ,REFSETID ,REFERENCEDCOMPONENTID,ACCEPTABILITY ,db1_SYSTEM_CREATED_DATE 
FROM $database.snomed_sct2_language_full
