...
INNER JOIN $db_source.MHS102ServiceTypeReferredTo s ON s.RecordNumber = r.RecordNumber AND s.UniqServReqID = r.UniqServReqID AND s.ServTeamTypeRefToMH = 'C02' 
...
INNER JOIN $db_source.MHS201CareContact c 
       ...
       AND c.AttendOrDNACode IN ('5','6') AND c.ConsMechanismMH IN ('01', '03')
