...
--     join updated to evaluate validity at time of data rather than reporting month
  ...
  and vcc.field = 'CodeProcAndProcStatus' 
  and vcc.Measure = 'CYP_ED_WaitingTimes' 
  and vcc.type = 'include' 
  and CASE
        WHEN CHARINDEX(':', ca.CodeProcAndProcStatus) > 0 
        THEN RTRIM(LEFT(ca.CodeProcAndProcStatus, CHARINDEX(':',ca.CodeProcAndProcStatus) -1))
...
--and ca.CodeProcAndProcStatus  in  ('51484002', '1111811000000109', '443730003', '444175001', '718023002', '984421000000104', '1323681000000103','1362001000000104')
;
